# enslaved-vr-external-research

Ongoing **public research** findings for the Enslaved: Odyssey to the West VR mod — leads, prior art, and technique write-ups gathered from publicly available sources (blogs, forums, existing tools, documentation), kept **separate from hands-on modding work**.
...
you always know where to look. You are in **enslaved-vr-external-research**.
...
| **enslaved-vr-external-research** ← you are here | Ongoing public-research leads — read-only input to the other five, never the other way around. |
